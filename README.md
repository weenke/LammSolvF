...
Fortran implementation of a finite element solver for the Lamm equation using a moving grid, extending the method of Claverie et al. (1975). Includes a C/Python interface.
...
times, coeffs = sawp_solver(
    ...
    n_steps = 200,
    omega   = omega,        # rad/s
    s       = 1e-13,        # sedimentation coefficient (1 S = 1e-13 s)
